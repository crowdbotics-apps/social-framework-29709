...
## Project Structure
    ...
    ├── social_framework_29709  # Django project configurations
...
1. Clone this repo and `cd social_framework_29709`
...
2. Clone this repo and `cd social_framework_29709`
